		...
		<nav class="navbar">
			<div class="container">
				...
				<div class="ml-auto d-flex align-items-center">
					<div class="mainMenu">
						<ul id="myDIV">
							<li class="bdtn active"><a href="<?php echo base_url('#home'); ?>">Beranda</a></li>
							<li class="bdtn"><a href="<?php echo base_url('#ourServices'); ?>">Pelayanan</a></li>
							<li class="bdtn"><a href="<?php echo base_url('#gallery'); ?>">Galeri</a></li>
							...
							<?php } } ?>
							<li class="bdtn"><a href="<?php echo base_url('#contactUs'); ?>">Kontak</a></li>
					...
					<?php if($this->session->userdata('id')){ ?>
						<div class="btn-group">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a href="<?php echo base_url('userbooking'); ?>" class="dropdown-item" type="button">Booking</a>
								<a href="<?php echo base_url('enduser'); ?>" class="dropdown-item" type="button">Profil</a>
								<a href="<?php echo base_url('enduser/logout'); ?>" class="dropdown-item" type="button">Keluar</a>
							</div>
						</div>
					<?php }  else{ ?>
