                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title float-left">Staff</div>
                            <a href="<?php anchor_to(AGENTS_CONTROLLER . '/addagent') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Tambah </a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        <?php if(!$agents){?>
                                            <tr>
                                                <td colspan="6" class="text-center"><h4 class="text-muted">Staff Tidak Ditemukan</h4></td>
                                            </tr>
                                        <?php } else{?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo esc($agent['experience'], true) ?> Tahun</td>
