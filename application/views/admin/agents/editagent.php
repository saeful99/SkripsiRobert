                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="agentName">Nama <span class="text-danger">*</span></label>
                                    <?php echo form_error('agentName', '<br><span class="text-danger">', '</span>'); ?>
                                    <input class="form-control" type="text" id="agentName" name="agentName" placeholder="Masukan Nama" value="<?php echo esc(set_value('agentName', $agent['agentName']), true)?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="totalBookings">Total Booking <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="text-danger mb-3"><b>Ukuran Gambar 500 X 500</b></div>
                                            ...
                                            <div class="input-file input-file-image">
                                                ...
                                                <label for="site-logo" class="label-input-file btn btn-black btn-round">
                                                    <span class="btn-label"><i class="fa fa-file-image"></i></span> Upload gambar
                                            </div>
                                        </div>
                                    </div>
