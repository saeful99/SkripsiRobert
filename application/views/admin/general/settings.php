            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <div class="card-title">Perbarui Pengaturan Website</div>
                  </div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" name="site-title" class="form-control form-control-lg py-3 px-5" id="title" value="<?php echo esc(set_value('site-title', $page_data['general']['title']), true)?>" placeholder="Judul Websit">
								...
								<div class="form-group">
									...
									<textarea rows="4" name="site-description" class="form-control resize-none" id="service-content" placeholder="Deskripsi"><?php echo esc(set_value('site-description', $page_data['general']['description']), true)?></textarea>
									<small>This will automatically be included in the <code>&lt;head&gt;</code> tag as Meta Description.</small>
								</div>
								<div class="form-group">
									<label for="site-keywords">Kata Kunci</label>
