                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="contact-phone">No. Telepon <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="contact-address">Alamat <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            <label for="map_src">Embed Maps<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <label for="map_wd">Lebar <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <label for="map_ht">Tinggi <span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(CONTACT_CONTROLLER); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Kembali</a>
